...
class MoDashboard extends Component {
            ...
            this.state.IsDataAvailable ?
                <div className="col-xs-12">
                    ...
                    <div className="col-sm-9 p4">
                        <div className="table-heading bg-b1">Ward Wise Applications</div>
                        <table className="table table-condensed table-bordered bg-white">
                            <thead>
                                <tr>
                                    <th rowSpan={2} className="text-center" style={{ verticalAlign: "middle" }}>Ward</th>
