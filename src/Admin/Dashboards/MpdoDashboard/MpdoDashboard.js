...
class MpdoDashboard extends Component {

    constructor(props) {
        super(props);
        this.state = { AdoptionsCount: {}, PanchayatWardWiseCount: [], IsDataAvailable: false };
    }
        ...
        MyAjax(
            ...
            (data) => {
                this.setState({
                    ...
                    PanchayatWardWiseCount: data["PanchayatWardWiseCount"]
                })
            },
            ...
            this.state.IsDataAvailable ?
                <div className="col-xs-12">
                    ...
                    <div className="col-sm-9 p4">
                        <div className="table-heading bg-b1">Panchayat Wise Applications</div>
                        <table className="table table-condensed table-bordered bg-white">
                            <thead>
                                <tr>
                                    <th rowSpan={2} className="text-center" style={{ verticalAlign: "middle" }}>Panchayat</th>
                                    <th colSpan={2} className="text-center">Open</th>
                            ...
                            <tbody>
                                {
                                    this.state.PanchayatWardWiseCount.map((ele, i) => {
                                        return (<tr key={i}>
                                            <td title={ele["Name"]}>
                                                {ele["Name"]}
                                            </td>
    ...
    goToApplications(DistrictId, District, MandalMunicipalityId, MandalMunicipality, PanchayatWardId, PanchayatWard, Status, Type, fromDate, toDate) {
