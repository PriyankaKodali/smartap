...
class PanchayatFunds extends Component {

    constructor(props) {
        super(props);
        this.state = {
            PanchayatId: null, FundsList: [], IsDataAvailable: false
        };
    }

    componentWillMount() {
        this.setState({ PanchayatId: this.props.match.params["id"] }, () => {
            this.getFundDetails();
        });
    }
    ...
    getFundDetails() {
        ...
        var url = ApiUrl + "/api/Funds/GetPanchayatFunds?PanchayatId=" + this.state.PanchayatId;
