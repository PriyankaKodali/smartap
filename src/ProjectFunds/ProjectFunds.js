...
class ProjectFunds extends Component {

    constructor(props) {
        super(props);
        this.state = {
            ProjectId: null, FundsList: [], IsDataAvailable: false
        };
    }
    ...
    getFundDetails() {
        ...
        var url = ApiUrl + "/api/Funds/GetProjectFunds?ProjectId=" + this.state.ProjectId;
